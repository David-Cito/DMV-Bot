...
exports.INSTANT_ALERT_DAYS = exports.LOCATIONS = exports.START_URL = void 0;
exports.scanRoadTestAppointments = scanRoadTestAppointments;
exports.runDiscovery = runDiscovery;
exports.monitorRoadTest = monitorRoadTest;
exports.formatResultMessage = formatResultMessage;
exports.uploadResultsToSupabase = uploadResultsToSupabase;
exports.getHstToday = getHstToday;
exports.daysBetween = daysBetween;
const playwright_1 = require("playwright");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const road_test_slots_1 = require("../../packages/db/road-test-slots");
// ============================================================================
// CONSTANTS
// ============================================================================
exports.START_URL = 'https://www12.honolulu.gov/csdarts/frmApptInt.aspx';
// Road test locations from the site
exports.LOCATIONS = ['Kapahulu', 'Kapolei', 'Koolau', 'Wahiawa', 'Waianae'];
const HST_TIME_ZONE = 'Pacific/Honolulu';
const INSTANT_ALERT_DAYS = 21; // Alert if appointment within 3 weeks
exports.INSTANT_ALERT_DAYS = INSTANT_ALERT_DAYS;
// File paths
...
// MAIN SCRAPING LOGIC
// ============================================================================
async function scanRoadTestAppointments(initialPage, options = {}) {
    const { scanDays = 45, takeScreenshots = true, verbose = false, } = options;
    ...
    exports.LOCATIONS.forEach(loc => slotsByLocation[loc] = 0);
    ...
    try {
        ...
        console.log(`[RoadTest] Navigating to: ${exports.START_URL}`);
        await page.goto(exports.START_URL, { timeout: 60000, waitUntil: 'domcontentloaded' });
        if (verbose)
        ...
        try {
            ...
            pageText = await page.evaluate(`document.body?.innerText?.slice(0, 500) || ''`);
            if (verbose)
        ...
        while (currentDate <= endDate) {
            ...
            if (dayLinkCount > 0) {
                ...
                let extraction;
                try {
                    extraction = await page.evaluate(EXTRACT_APPOINTMENTS_SCRIPT);
                }
                catch (e) {
                    // Context may have been destroyed by navigation, wait and retry
                    await page.waitForLoadState('domcontentloaded');
...
async function runDiscovery(options = {}) {
    ...
    console.log(`[Discovery] Target: ${exports.START_URL}`);
    ...
    try {
        await page.goto(exports.START_URL, { waitUntil: 'load', timeout: 60000 });
...
// ============================================================================
async function monitorRoadTest(options = {}) {
    const { headless = process.env.ROAD_TEST_HEADLESS !== 'false' && process.env.CI === 'true', slowMo = process.env.CI === 'true' ? 0 : 300, scanDays = 45, verbose = process.env.ROAD_TEST_VERBOSE === 'true', } = options;
    ...
    try {
        const warmupResponse = await context.request.get(exports.START_URL, { timeout: 5000 });
        if (verbose)
...
// ============================================================================
async function uploadResultsToSupabase(result) {
    try {
        ...
        const upsertResult = await (0, road_test_slots_1.upsertRoadTestSlots)(slotRecords);
        ...
        const disappearedCount = await (0, road_test_slots_1.markDisappearedSlots)(cutoff);
        console.log(`[Supabase] Marked ${disappearedCount} slots as disappeared`);
        // Record the scan
        await (0, road_test_slots_1.recordRoadTestScan)({
            ok: result.ok,
