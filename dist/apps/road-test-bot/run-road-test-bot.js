...
// MONITORING MODE
// ============================================================================
async function runMonitoringMode(headless, days, upload) {
    console.log('='.repeat(60));
    ...
    const result = await (0, road_test_bot_1.monitorRoadTest)({ headless, scanDays: days });
...
//# sourceMappingURL=run-road-test-bot.js.map